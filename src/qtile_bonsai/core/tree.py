...
class Tree:
    ...
    def tab(
        ...
        *,
        ...
        if self.is_empty:
            ...
            pane, added_nodes = self._add_tab_at_new_level(
                at_pane, using_pane=using_pane
            )
    ...
    def merge_to_subtab(
        ...
        #   TC or SC?
        self.remove(src_node, normalize=normalize)
        self.tab(dest_node, new_level=True, using_pane=src_node)
        print(self)
    ...
    def _add_tab_at_new_level(
        self, at_pane: Pane, using_pane: Pane | None = None
    ) -> tuple[Pane, list[Node]]:
        ...
        if using_pane is None:
            ...
            new_pane = using_pane
            new_pane.box.principal_rect = Rect.from_rect(at_pane.principal_rect)
